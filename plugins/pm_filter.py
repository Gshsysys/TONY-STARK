...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
            text=script.SUR_TXT.format(query.from_user.mention),
            reply_markup=reply_markup,
            parse_mode=enums.ParseMode.HTML
        )     
        ...
        buttons = [[
            ...
            InlineKeyboardButton('𝙁𝙄𝙇𝙀 𝙎𝙏𝙊𝙍𝙀', callback_data='store_file')
        ], [
            InlineKeyboardButton('𝘾𝙊𝙉𝙉𝙀𝘾𝙏𝙄𝙊𝙉𝙎', callback_data='coct'),
            InlineKeyboardButton('𝙀𝙓𝙏𝙍𝘼 𝙈𝙊𝘿𝙎', callback_data='extra')   
        ], [
            InlineKeyboardButton('𝙃𝙊𝙈𝙀', callback_data='start'),
            InlineKeyboardButton('𝙎𝙏𝘼𝙏𝙎', callback_data='stats')
        ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(                     
        ...
        buttons = [[
            InlineKeyboardButton('​𝙎𝙐𝙋𝙋𝙊𝙍𝙏', callback_data="group_info"),
          ],[
            InlineKeyboardButton('𝙃𝙊𝙈𝙀', callback_data='start'),
